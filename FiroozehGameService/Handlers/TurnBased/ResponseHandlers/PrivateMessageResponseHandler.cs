...
namespace FiroozehGameService.Handlers.TurnBased.ResponseHandlers
{
    ...
    {
        public static int ActionCommand => TurnBasedConst.OnPrivateMessage;

        protected override void HandleResponse(Packet packet)
        {
            var data = JsonConvert.DeserializeObject<DataPayload>(packet.Data);

            TurnBasedEventHandlers.NewMessageReceived?.Invoke(this, new MessageReceiveEvent
            {
