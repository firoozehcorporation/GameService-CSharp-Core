// <copyright file="ChooseNextHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class ChooseNextHandler : BaseRequestHandler
    {
        ...
        {
            return new Packet(TurnBasedHandler.PlayerHash, TurnBasedConst.OnChooseNext,
