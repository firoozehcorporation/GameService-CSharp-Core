// <copyright file="PeerConfigResponseHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class PeerConfigResponseHandler : BaseResponseHandler
    {
        public static int ActionCommand => RealTimeConst.ActionConfigPeer;
