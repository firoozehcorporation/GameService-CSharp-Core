// <copyright file="ObserverHandler.cs" company="Firoozeh Technology LTD">
...
namespace FiroozehGameService.Handlers.RealTime.RequestHandlers
{
    internal class ObserverHandler : BaseRequestHandler
    {
        ...
        {
            return new Packet(RealTimeHandler.PlayerHash, RealTimeConst.ActionObserver, GProtocolSendType.UnReliable, buffer);
        }
