// <copyright file="SnapShotHandler.cs" company="Firoozeh Technology LTD">
...
namespace FiroozehGameService.Handlers.RealTime.RequestHandlers
{
    internal class SnapShotHandler : BaseRequestHandler
    {
        ...
        {
            return new Packet(RealTimeHandler.PlayerHash, RealTimeConst.ActionSnapShot, GProtocolSendType.Reliable);
        }
