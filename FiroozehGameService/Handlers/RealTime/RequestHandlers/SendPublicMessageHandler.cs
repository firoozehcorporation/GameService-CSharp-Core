// <copyright file="SendPublicMessageHandler.cs" company="Firoozeh Technology LTD">
...
namespace FiroozehGameService.Handlers.RealTime.RequestHandlers
{
    internal class SendPublicMessageHandler : BaseRequestHandler
    {
        ...
        {
            return new Packet(RealTimeHandler.PlayerHash, RealTimeConst.ActionPublicMessage, GProtocolSendType.UnReliable,
                payload.Payload);
        }
