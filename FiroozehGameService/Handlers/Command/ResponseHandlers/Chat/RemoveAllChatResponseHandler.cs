// <copyright file="RemoveAllChatResponseHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class RemoveAllChatResponseHandler : BaseResponseHandler
    {
        internal static int ActionCommand => CommandConst.ActionRemoveAllMessages;
