// <copyright file="JoinVoiceChannelHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class JoinVoiceChannelHandler : BaseRequestHandler
    {
        ...
        private static Packet DoAction(string channelKey)
        {
            return new Packet(
                ...
                CommandConst.ActionJoinVoiceChannel,
