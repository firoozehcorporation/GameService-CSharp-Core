// <copyright file="DestroyVoiceChannelHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class DestroyVoiceChannelHandler : BaseRequestHandler
    {
        public static string Signature
            => "DESTROY_VOICE_CHANNEL";

        private static Packet DoAction(string channelId)
        {
            return new Packet(
                CommandHandler.PlayerHash,
                CommandConst.ActionDestroyVoiceChannel,
