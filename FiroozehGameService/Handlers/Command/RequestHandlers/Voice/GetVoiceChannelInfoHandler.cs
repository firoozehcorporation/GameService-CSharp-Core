// <copyright file="GetVoiceChannelInfoHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class GetVoiceChannelInfoHandler : BaseRequestHandler
    {
        public static string Signature
            => "GET_VOICE_CHANNEL_INFO";

        private static Packet DoAction(string channelKey)
        {
            return new Packet(
                CommandHandler.PlayerHash,
                CommandConst.ActionGetVoiceChannelInfo,
