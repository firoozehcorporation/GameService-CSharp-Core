// <copyright file="CreateVoiceChannelHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class CreateVoiceChannelHandler : BaseRequestHandler
    {
        ...
        {
            return payload.GetType() == typeof(GSLiveMediaOption.VoiceOption);
        }

        protected override Packet DoAction(object payload)
        {
            if (!CheckAction(payload)) throw new ArgumentException();
            return DoAction(payload as GSLiveMediaOption.VoiceOption);
        }
    }
}