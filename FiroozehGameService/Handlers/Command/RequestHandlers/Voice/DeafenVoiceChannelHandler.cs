// <copyright file="DeafenVoiceChannelHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class DeafenVoiceChannelHandler : BaseRequestHandler
    {
        public static string Signature
            => "DEAFEN_VOICE_CHANNEL";
