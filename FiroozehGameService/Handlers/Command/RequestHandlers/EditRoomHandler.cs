// <copyright file="EditRoomHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class EditRoomHandler : BaseRequestHandler
    {
        ...
        {
            return payload.GetType() == typeof(GSLiveOption.EditRoomOption);
        }

        protected override Packet DoAction(object payload)
        {
            if (!CheckAction(payload)) throw new ArgumentException();
            return DoAction(payload as GSLiveOption.EditRoomOption);
        }
    }
}