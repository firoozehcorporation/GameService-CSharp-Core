// <copyright file="RemoveAllChatsHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class RemoveAllChatsHandler : BaseRequestHandler
    {
        ...
        private static Packet DoAction(Message message)
        {
            return new Packet(
                ...
                CommandConst.ActionRemoveAllMessages,
