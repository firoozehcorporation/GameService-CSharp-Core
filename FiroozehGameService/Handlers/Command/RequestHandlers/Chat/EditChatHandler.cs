// <copyright file="EditChatHandler.cs" company="Firoozeh Technology LTD">
...
{
    internal class EditChatHandler : BaseRequestHandler
    {
        public static string Signature => "EDIT_CHAT";

        private static Packet DoAction(Message message)
        {
            return new Packet(
                CommandHandler.PlayerHash,
                CommandConst.ActionEditChat,
