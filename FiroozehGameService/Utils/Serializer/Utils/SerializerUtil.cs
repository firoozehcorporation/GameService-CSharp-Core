...
using Types = FiroozehGameService.Utils.Serializer.Models.Types;
            ...
            while (writeStream.CanRead())
            {
                ...
                switch (obj)
                {
                    ...
                    default:
                        ...
                        else throw new GameServiceException("SerializerUtil -> The Type " + obj.GetType() + " is Not Supported");
                        break;
                }
            }
            ...
            using (var packetWriter = ByteArrayReaderWriter.Get(packetBuffer))
            {
                ...
                foreach (var objectInfo in objectInfos)
                {
                    ...
                    switch (objectInfo.Type)
                    {
                        ...
                        case Types.Ulong:  packetWriter.Write((ulong) objectInfo.Src); break;
                        case Types.Bool:
                            byte data = 0x0;
            ...
            using (var packetReader = ByteArrayReaderWriter.Get(buffer))
            {
                ...
                for (var i = 0; i < count; i++)
                {
                    ...
                    switch (type)
                    {
                        ...
                        case Types.Ulong:       readStream.Add(packetReader.ReadUInt64()); break;
                        ...
                        case Types.CharArray:   readStream.Add(GetCharsFromBuffers(packetReader.ReadBytes(packetReader.ReadUInt16()))); break;
                        case Types.DoubleArray: readStream.Add(GetDoublesFromBuffers(packetReader.ReadBytes(packetReader.ReadUInt16()))); break;
                        case Types.FloatArray:  readStream.Add(GetFloatsFromBuffers(packetReader.ReadBytes(packetReader.ReadUInt16()))); break;
                        case Types.IntArray:    readStream.Add(GetIntsFromBuffers(packetReader.ReadBytes(packetReader.ReadUInt16()))); break;
                        case Types.LongArray:   readStream.Add(GetLongsFromBuffers(packetReader.ReadBytes(packetReader.ReadUInt16()))); break;
                        case Types.StringArray: readStream.Add(GetStringsFromBuffer(packetReader.ReadBytes(packetReader.ReadUInt16()))); break;
                        case Types.Null:        readStream.Add(null); break;
                        case Types.CustomObject:
