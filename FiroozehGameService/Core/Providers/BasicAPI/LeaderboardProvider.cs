// <copyright file="LeaderboardProvider.cs" company="Firoozeh Technology LTD">
...
namespace FiroozehGameService.Core.Providers.BasicAPI
{
    ...
    /// </summary>
    internal class LeaderboardProvider : ILeaderboardProvider
    {
        ...
        public async Task<LeaderBoardDetails> GetLeaderBoardDetails(string leaderBoardId, int scoreLimit = 10,
