// <copyright file="Or.cs" company="Firoozeh Technology LTD">
...
using System.Linq;
using FiroozehGameService.Models.BasicApi.DBaaS.Matcher;
...
namespace FiroozehGameService.Models.BasicApi.DBaaS.Operators
{
    /// <summary>
    ///     Represents Or Operator Model In Game Service Basic API
    /// </summary>
    [Serializable]
    public class Or : MatcherCore
    {
